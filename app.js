...
mongoose.connect("mongodb://localhost:27017/eusersDB", {
...
app.post("/charge", function (req, res) {
  if (req.isAuthenticated()) {
    ...
    const stripe = require("stripe")(
      ...
      "sk_test_51Hlf3gBAaJOZI8bnujGmd3Lt1lFd0oW1k9E1dtDWj7TB3iiyfVlkzVYb9KBZ8S2J9CWHbwaoaXdApZOmNMyxDHRi00uvKc7rgF"   );
